...
var Collection = function (_a) {
    ...
    var _f = react_use_1.useLocalStorage(block.id, {
        collectionViewId: viewIds[0]
    }), collectionState = _f[0], setCollectionState = _f[1];
    ...
    return (React.createElement("div", { className: 'notion-collection' },
        React.createElement("div", { className: 'notion-collection-header', style: style },
            title && (React.createElement("div", { className: 'notion-collection-header-title' },
                React.createElement(React.Fragment, null,
                    ...
                    title))),
            viewIds.length > 1 && (React.createElement(rc_dropdown_1["default"], { trigger: triggers, overlay: React.createElement(rc_menu_1["default"], { onSelect: onChangeView }, viewIds.map(function (viewId) {
                    var _a;
                    return (React.createElement(rc_menu_1.Item, { key: viewId, className: 'notion-collection-view-type-menu-item' },
                ...
                React.createElement(CollectionViewColumnDesc, { className: 'notion-collection-view-dropdown', collectionView: collectionView },
                    React.createElement(chevron_down_icon_1.ChevronDownIcon, { className: 'notion-collection-view-dropdown-icon' }))))),
        React.createElement(collection_view_1.CollectionView, { collection: collection, collectionView: collectionView, collectionData: collectionData, padding: padding, width: width })));
};
var CollectionViewColumnDesc = function (_a) {
    ...
    return (React.createElement("div", __assign({ className: utils_1.cs('notion-collection-view-type', className) }, rest),
        React.createElement(collection_view_icon_1.CollectionViewIcon, { className: 'notion-collection-view-type-icon', type: type }),
