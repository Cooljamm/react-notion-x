...
var Collection = function (_a) {
    ...
    var _f = useLocalStorage(block.id, {
        ...
        React.createElement("div", { className: 'notion-collection-header', style: style },
            title && (React.createElement("div", { className: 'notion-collection-header-title' },
                React.createElement(React.Fragment, null,
                    React.createElement(PageIcon, { block: block, className: 'notion-page-title-icon' }),
                    title))),
            viewIds.length > 1 && (React.createElement(Dropdown, { trigger: triggers, overlay: React.createElement(Menu, { onSelect: onChangeView }, viewIds.map(function (viewId) {
                    var _a;
